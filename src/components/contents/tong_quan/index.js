...
const TongQuanContent = () => {
    ...
    const tongSoCongNhanVien = allNhanVienChamCong?.reduce((accumulator, currentItem) => accumulator + (currentItem.tongSoGioLamViec+currentItem.tongSoGioLamThem), 0);
    ...
    console.log(gioLamTrungBinhMoiThangCuaNhanVien)
    return(
        <>
